...
const ChatMe: FC<ChatMeProps> = () => {
    ...
    return (
        <>
            <Hidden mdDown>
                <Stack flexDirection="row" gap={1} justifyContent="center" alignItems="center" onClick={handleOpenNavAvatar} sx={{ cursor: "pointer" }} position="fixed" top={{ xs: "100%", md: "90%" }} right={{ md: "12%" }} zIndex={999}>
                            ...
                            <Box pt={1}>
                                <FormControl fullWidth sx={{ border: 2, borderColor: "divider", borderRadius: 2 }}>
                                    ...
                                    >
                                        ...
                                        <Button type="submit" size="small" color="success" variant="contained" sx={{ px: 1, fontSize: "0.625rem" }} endIcon={<SendRoundedIcon sx={{ height: 18, width: 18 }} />} onClick={handleClick}>
                                            Send
                                        </Button>
                                    </Stack>
                                </FormControl>
