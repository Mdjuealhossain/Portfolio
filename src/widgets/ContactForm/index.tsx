...
const ContactForm = () => {
  return (
    <Grid container spacing={{ md: 3 }} bgcolor={{ md: "background.paper" }} borderRadius={3} boxShadow={25}>
      <Grid bgcolor={{ xs: "background.paper" }} borderRadius={3} item xs={12} md={7} display="flex" flexDirection="column" gap={3} p={3}>
        ...
        <TextField rows={4} variant="filled" fullWidth placeholder="Message" multiline />
        <Box>
      ...
      <Grid item xs={12} md={5} bgcolor={{ xs: "background.paper" }} borderRadius={3} p={3} mt={{ xs: 3, md: 0 }}>
        ...
        <Box>
          <Stack flexDirection="row" gap={3}>
            ...
            <Box>
              <Divider orientation="vertical" variant="fullWidth" sx={{ borderRightWidth: "2px" }} />
            </Box>
            <Box pb={2}>
